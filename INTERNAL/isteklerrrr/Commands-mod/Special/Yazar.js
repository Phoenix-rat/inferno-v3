...
module.exports.execute = async (client, message, args) => {
    ...
    if(!member.roles.cache.has(client.role("spYazar")) ){
     member.roles.add(client.role("spYazar")).catch(() => {})
     message.react(client.emoji("okey")).catch(() => { })
} else
     member.roles.remove(client.role("spYazar")).catch(() => {})
     message.react(client.emoji("okey")).catch(() => { })
