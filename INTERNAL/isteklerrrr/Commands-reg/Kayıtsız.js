...
exports.execute = async (client, message, args) => {
    ...
    if (member.roles.cache.size == 2 && member.roles.cache.has(client.role("regUnreg"))) return message.react(client.emoji("red")).catch(() => { })
    member.roles.set([client.role("regUnreg")]).catch(() => { })
