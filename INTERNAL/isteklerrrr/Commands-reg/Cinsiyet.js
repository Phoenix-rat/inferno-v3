...
exports.execute = async (client, message, args) => {
    ...
    if (!member.roles.cache.get(client.role("regWoMans")) && !member.roles.cache.get(client.role("regMans"))) return message.react(client.emoji("red")).catch(() => { })

    if (member.roles.cache.get(client.role("regWoMans"))) {
        ...
        if (member.roles.cache.get(client.role("regMans"))) {
...
exports.conf = {
    ...
    aliases: ["cinsiyet", "cinsiyetdüzelt"],
    timeout: "7000",
