...
class Rolver extends Command {
    ...
    async run(client, message, args, data) {
        ...
        if (!args[0] || (args[0] !== 'vip' && args[0] !== 'dj' && args[0] !== 'editör' && args[0] !== 'vokal' && args[0] !== 'ressam' && args[0] !== 'streamer' && args[0] !== 'müzisyen' && args[0] !== 'tasarımcı')) return message.channel.send('Test').then(x => x.delete({ timeout: 5000 }));
